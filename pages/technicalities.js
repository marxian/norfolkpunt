    ...
    <div className="center mw7 pv0 ph2">
      ...
      <article className="bt bb b--black-10 mb4">
        ...
        <p>
          ...
          <em>Norfolk Punt Club</em> constitution which refer to the association
          are set out below.
        </p>
          ...
          <ol start="65">
            ...
            <li>
              ...
              <p>
                ...
                Committee and shall take office from 1st January next following
                for one year.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                become Temporary Members of the Club. The granting of Temporary
                Membership to any member of the POA Committee shall not oblige
                such member to pay any Entrance fee or annual subscription but
                such Temporary members shall not be entitled to exercise any of
                the rights and privileges of Club membership and for the
                avoidance of doubt they shall have no voting rights in Club
                meetings.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                Owners only. All Punts Owners whether or not Club Members shall
                be entitled to attend the POA Annual General Meeting and any
                Special General POA Meetings. The election, retirement and
                continuation of membership of the POA Committee shall be in
                accordance with provisions of Section 4 of the Club Constitution
                (so far as relevant) and the voting and procedures to be
                followed at such meetings shall be in accordance with the Club
                provisions therein save that at POA meetings ten owners shall
                form a quorum.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                at the direction of the POA Committee to examine Punt handicaps,
                changes to boat or sail measurements and any technical issues
                that might affect the Punt Class. This shall be a sub committee
                of the POA and shall meet in accordance with the Rules of the
                POA and shall report back to the POA Committee.
              </p>
              <p>
